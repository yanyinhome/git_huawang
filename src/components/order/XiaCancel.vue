    ...
    methods:{
      ...
      loadBottom() {
        ...
        if(this.pageDate.page==this.pageDate.pages){
          ...
          this.$http({method:"post",url:"/api/order/order",data:Object.assign({},{token:this.userInfo.token,type:"2",flag:'6'})})
            .then(
              res=>{
                console.log(res)
      ...
      getlist(data,next){
        this.$http({method:"post",url:"/api/order/order",data:Object.assign({},{token:this.userInfo.token,type:"2",flag:'6'},data?data:{})})
          .then(
            res=>{
              console.log(res)
              if(res.data.code==200){
