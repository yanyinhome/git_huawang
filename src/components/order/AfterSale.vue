        ...
        <div class="orders_box" >
          <div class="item_box" v-for="(item,index) in OrderList" :key="index">
            <template v-if="item.state=='0'">
              ...
              <div class="body" @click="gofefund_detail(item.id)">
                <div class="left">
                  <div class="fonts">
                    收
                  </div>
              ...
              <div class="btn_item_box">
                <div class="btn">
                  <mt-button v-bind:class="btnClass.receive" @click="gofefund_detail(item.id)">同意退款</mt-button>
                </div>
                <div class="btn">
                  <mt-button v-bind:class="btnClass.cancle" @click="gofefund_detail(item.id)">拒绝退款</mt-button>
                </div>
              </div>
            </template>
            <template v-if="item.state=='1'">
              ...
              <div class="result_img refuse" @click="gofefund_detail(item.id)">&nbsp;</div>
            </template>
            ...
            <template v-if="item.status==15"  >
              ...
              <div class="body" @click="gofefund_detail(item.id)">
                ...
                <div class="right">
                  <div class="info_img chuli pingtai">
                    平台介入
                  </div>
                  <p class="order_info"><span>{{item.or_shou_name}}</span>&nbsp;&nbsp;&nbsp;&nbsp;<span>{{item.phone}}</span></p>
                  <p class="address">{{item.dizhi}}</p>
  ...
  export default {
    ...
    data(){
      return{
        ...
        allLoaded:false,
        OrderList:[
         /* {or_shou_name:'陈女士',or_number:"1234567891234578",or_flower_total:'299.00',dizhi:"河南省郑州市金水区",or_delivery_time:'2019-12-31 18:00-19:00',or_shou_phone:"133****1234",songda_time:'2019-12-31 18:35',state:'0'},
          {or_shou_name:'陈女士',or_number:"1234567891234578",or_flower_total:'299.00',dizhi:"河南省郑州市金水区",or_delivery_time:'2019-12-31 18:00-19:00',or_shou_phone:"133****1234",songda_time:'2019-12-31 18:35',state:'1'},
          {or_shou_name:'陈女士',or_number:"1234567891234578",or_flower_total:'299.00',dizhi:"河南省郑州市金水区",or_delivery_time:'2019-12-31 18:00-19:00',or_shou_phone:"133****1234",songda_time:'2019-12-31 18:35',state:'2'},*/
        ]
      }
    },
    computed:{
    ...
    methods:{
      ...
      loadBottom() {
        ...
        if(this.pageDate.page==this.pageDate.pages){
          ...
          this.pageDate.page++;
          this.$http({method:"post",url:"/api/order/order",data:Object.assign({},{token:this.userInfo.token,type:"1",flag:'12'},{page:this.pageDate.page})})
            .then(
              res=>{
                console.log(res)
      ...
      gofefund_detail(id){
        this.$router.push({path:'/refunddetail',query:{id:id,type:1}})
      },
      getlist(data,next){
        this.$http({method:"post",url:"/api/order/order",data:Object.assign({},{token:this.userInfo.token,type:"1",flag:'12'},data?data:{})})
          .then(
            res=>{
              console.log(res)
              if(res.data.code==200){
    ...
    .body{
      ...
      .right{
        ...
        .info_img{
          ...
          box-sizing: border-box;
          padding-top: 2.5rem;
          background: url("../../assets/img/after_sale.png") no-repeat center 0.3rem/90%;
        ...
        .pingtai{
          background: url("../../assets/img/after_sale.png") no-repeat center 0rem/75%;
        }
        p{
          padding: 0.25rem 0;
        }
